...
#define DNS_DEF_RESOLVE_IP1 "139.196.135.135"
#define DNS_DEF_RESOLVE_IP2 "106.15.100.2"
#define DNS_DEF_RESOLVE_IP3 "106.15.83.29"
...
int dns_getaddrinfo(char *domain, char *ip[DNS_RESULT_COUNT])
{
    ...
    ip[0] = DNS_DEF_RESOLVE_IP1;
    ip[1] = DNS_DEF_RESOLVE_IP2;
    ip[2] = DNS_DEF_RESOLVE_IP3;
    return 0;
}
#endif
