...
static const char *LINKKIT_SDK_C_VERSION_LV_DEFINES = "V2.3.1_191205_80e1150e";
...
void IOT_SetLogLevel(IOT_LogLevel level)
{
    ...
    HAL_Printf("[LK-PRT] log level set as: [ %d ]\r\n", lvl);
}
...
int IOT_Ioctl(int option, void *data)
{
    ...
    switch (option) {
        ...
        break;
        case IOTX_IOCTL_GET_VERSION_LV_DEFINES: {
            memcpy(data, LINKKIT_SDK_C_VERSION_LV_DEFINES, strlen(LINKKIT_SDK_C_VERSION_LV_DEFINES));
        }
        break;
#if defined(DEVICE_MODEL_ENABLED) && !defined(DEPRECATED_LINKKIT)
