...
#ifndef LINKKIT_SDK_C_VERSION
#define LINKKIT_SDK_C_VERSION     "V2.3.0_200106_a5ab8aa93bb4e941fa90412208a84e315702c62b" //commit 为最新的linkkit commit id
#endif
...
int IOT_Linkkit_Open(iotx_linkkit_dev_type_t dev_type, iotx_linkkit_dev_meta_info_t *meta_info)
{
    ...
    sdk_crit("SDK Version:%s", LINKKIT_SDK_C_VERSION);
