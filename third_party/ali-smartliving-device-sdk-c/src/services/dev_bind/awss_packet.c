...
#define SERVICE_VERSION         "{\"ErrCode\":\"1.0\",\"OfflineOTA\":\"1.0\",\"OfflineLog\":\"1.0\"}"
...
static void * awss_get_dev_info(void *dev_info, int len)
{
    ...
    snprintf(dev_info, len - 1, AWSS_DEV_INFO_FMT, AWSS_VER, pk, dev_name, mac_str, ip_str, os_get_conn_encrypt_type(), version, DEV_DIAGNOSIS_SUPPORTED_SERVICE, SERVICE_VERSION);
